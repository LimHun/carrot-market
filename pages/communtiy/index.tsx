...
const Community: NextPage = () => {
    ...
    const onClick = () => {
        router.push("/communtiy/write") 
    };
    return (
        <Layout title="동내생활" hasTabBar>
            <div className="py-2 px-4 space-y-8">
                {[1,2,3,4,5,6,7,8,9,0].map((_,i)=>(
                    <Link href={`/communtiy/${i}`}>
                        <a className="cursor-pointer">  
                            ...
                            <div className="flex space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[1px] w-full mb-5">
                ...
                <button onClick={onClick} className="hover:bg-orange-500 cursor-pointer transition-colors fixed bottom-28 right-5 bg-orange-400 rounded-full text-white p-4 shadow-xl">
                    <svg
                    className="w-6 h-6"
                    fill="none"
                    stroke="currentColor"
