			...
			<div className="mt-12">
						...
						<> 
							<div className="flex flex-col items-center">
								...
								<div className="grid border-b w-full mt-9 grid-cols-2">
									<button
										className={cls("pb-4 font-medium text-sm border-b-2", method === "email" ? "border-organge-500 text-orange-400" : "border-transparent hover:text-gray-400 text-gray-500")}
										onClick={onEmailClick}
									>
										Email
									</button>
									<button
										className={cls("pb-4 font-medium text-sm border-b-2", method === "phone" ? "border-organge-500 text-orange-400" : "border-transparent hover:text-gray-400 text-gray-500")}
				...
				<div className="mt-8">
					...
					<div className="grid grid-cols-2 mt-2 gap-3">
						<button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none">
							<svg
								className="w-5 h-5"
								aria-hidden="true"
								fill="currentColor"
