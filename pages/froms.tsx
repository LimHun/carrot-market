    ...
    return (
        <form onSubmit={handleSubmit(onValid, onInvalid)}>
            <div className="p-10">
                ...
                <input
                    className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 mt-3"
                    {...register("email", {
                        required: "이메일 필수",
                        validate: {
                ...
                <input
                    className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 pt-3"
