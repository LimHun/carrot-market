                ...
                <div className="mb-8">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="flex items-center justify-between space-x-2 ap" >
                            <button className="flex-1 bg-orange-500 text-white py-3 rounded-md focus:outline-none focus:ring-offset-2 font-medium hover:bg-orange-600 focus:ring-orange-500">Talk to seller</button>
                            <button className="p-3 flex item-center justify-center text-gray-400 hover:bg-gray-100 rounded-md space-x-2">
                                <svg
                                    className="h-6 w-6 "
